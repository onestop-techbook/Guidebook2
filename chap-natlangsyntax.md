...
サークル参加は 有**料** 。「通常スペース」（ 出展**料**： [i:5000] **円** ）、.. 「ゆったりスペース」（ 出展**料** ： [i:8000] **円** ）の [i:2] 種類あり、..申込期限は [i:９] [u:月] [i:２２] [u:日] 、出展**料**支払期限は [i:９] [u:月] [i:３０] [u:日] 。サークル配置確定は [i:１１] [u:月] [i:８] [u:日] 、..発送期限は [i:１２] [u:月] [i:１２] [u:日] である。 .. 一般参加は 無**料**  。  
...
[u:速読]、[u:精読]の対象として、**専門書**や[i:技術書]を想定しています。一部の [u:速読エリート] を除けば、これらの本を[u:速読]するのは難しいと見ています。
...
**そういう速読術**を極めていない[u:人]でも、これらの[i:本]を**読み**やすくする[u:方法]を[i:発見]したので**シェア**します。
