...
＝＝＝＝＝＝＝＝ 
**（ケースE）**  
サークル参加は **有料** 。「通常スペース」 **出展料：5０００円** 、.. 「ゆったりスペース」 **出展料：８０００円** ）の２種類あり、..申込期限は ９月２２日*** 、**出展料支払期限**は [u:９月３０日] 。サークル配置確定は [u:１１月８日] 、..発送期限は [u:12月12日] である。 .. 一般参加は **無料**  。  
＝＝＝＝＝＝＝
　  
...
＝＝＝＝＝＝＝  
**（ケースF）**  
サークル参加は 有**料** 。「通常スペース」（ 出展**料**： *５０００* **円** ）、.. 「ゆったりスペース」（ 出展**料** ： *８０００* **円** ）の *２* 種類あり、..申込期限は *９* [u:月] *２２* [u:日] 、出展**料**支払期限は *９* [u:月] *３０* [u:日] 。サークル配置確定は *１１* [u:月] *８* [u:日] 、..発送期限は *12* [u:月] *12* [u:日] である。 .. 一般参加は 無**料**  。  
＝＝＝＝＝＝＝
　  
　  


これは、完全一致で「円」、「料」、は**ボールド**、数字は*イタリック*、「月」、「日」は[u:アンダーバー]になるよう指定した場合です。  
...
[u:そういう速読術]を極めていない人（※1）でも、これらの本を[u:読み]やすくする方法を発見したのでシェアします。
...
*速読*、**精読**の[u:対象]として、*専門書*や**技術書**を[u:想定]しています。*一部*の**速読エリート**を除けば、これらの[u:本]を*速読*するのは難しいと見ています。

**そういう速読術**を極めていない[u:人]（※1）でも、これらの*本*を**読み**やすくする[u:方法]を*発見*したので**シェア**します。
